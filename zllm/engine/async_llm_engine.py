...
from typing import AsyncIterator, Callable, Dict, Iterable, List, Optional, Set, Tuple, Union
from zllm.config.config import ModelConfig, SystemConfig
...
class RequestTracker:
    ...
    def add_request(self, request_id: str, **kwargs) -> AsyncStream:
        ...
        self._new_requests.put_nowait(
            (stream, {"seq_id": request_id, **kwargs})
        )
    ...
    def get_new_and_finished_requests(self) -> Tuple[List[Dict], Set[str]]:
        ...
        while not self._new_requests.empty():
            ...
            if stream.requst_id in finished_requests:
                stream.finish()
                continue
            self._request_streams[stream.requst_id] = stream
...
class AsyncLLMEngine(LLMEngine):
    ...
    def __init__(self, engine: _AsyncLLMEngine, verbose: bool = False) -> "AsyncLLMEngine":
        self.engine = engine
    ...
    async def _engine_abort(self, request_ids: Iterable[str]):
        # TODO: Add support for aborting request in scheduler
        pass
