...
class EngineArgs:
    ...
    model: str = '/home/duyong/model-zoos/meta-llama/Meta-Llama-3.1-8B-Instruct/'
    trust_remote_code: Optional[bool] = True
    dtype: Optional[str] = 'bfloat16'
    tokenizer: Optional[str] = None
    max_num_seqs: Optional[int] = 16
    max_batched_tokens: Optional[int] = 8*1024
    num_gpu_blocks: Optional[int] = 200
    block_size: Optional[int] = 256
    tensor_parallel_size: Optional[int] = 1


    def create_engine_config(self) -> SystemConfig:
